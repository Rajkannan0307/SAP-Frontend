...
const CC_SubContractScreen = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            const response = await GetPackingBomApi({ type: CCTypeEnum.SC })
...
export default CC_SubContractScreen;