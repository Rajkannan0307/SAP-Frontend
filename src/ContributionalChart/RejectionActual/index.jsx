...
import { TrnRejectionActual_BULKApi, GetTrnRejectionActualApi } from '../../controller/ContributionalChartApiService'
import ValidationResponseGrid from '../../components/ValidationResponseTable'
import { toast } from 'react-toastify'

const CC_RejectionActual = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            ...
            try {
                setLoading(true)
                const response = await GetTrnRejectionActualApi({
    ...
    const columns = [
        {
            field: "trn_rej_id", headerName: "SI No", width: 80,
            renderCell: (params) => params.api.getRowIndexRelativeToVisibleRows(params.id) + 1
        },
        { field: "plant", headerName: "Plant", flex: 1 },
        { field: "profit_center", headerName: "Profit Center", flex: 1 },
        { field: "cost_center", headerName: "Cost Center", flex: 1 },
        { field: "rej_value", headerName: "Rej Value", flex: 1 },
        ...
        >
            ...
            >
                <DataGrid
                    ...
                    getRowId={(row) => row.trn_rej_id} // Specify a custom id field
...
const ExcelUploadModal = ({
    ...
    async function downloadProductionPlanTemplate() {
        ...
        const worksheet = workbook.addWorksheet("Trn_RejectionActual");
        ...
        saveAs(
            ...
            "TrnRejectionActual_Template.xlsx"
        );
    }
    ...
    const handleUploadData = async () => {
        ...
        try {
            ...
            const response = await TrnRejectionActual_BULKApi(formData)
...
export default CC_RejectionActual
