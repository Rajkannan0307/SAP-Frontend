...
const CC_ActualConsumptionPlan = () => {
    ...
    const handleSearch = () => {
        ...
        if (!text) {
            ...
            const filteredRows = originalRows.filter((row) =>
                ['plant', 'part_no', 'cons_qty'].some((key) => {
                    const value = row[key];
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            ...
            setLoading(true)
            const response = await getTrnActualConsumptionPlan({
        ...
        >
            ...
            >
                <DataGrid
                    ...
                    getRowId={(row) => row.act_cons_id} // Specify a custom id field
...
export default CC_ActualConsumptionPlan
