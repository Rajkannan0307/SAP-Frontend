...
const CC_StoresAndSparesScreen = () => {
    ...
    const columns = [
        ...
        { field: "fg_part_no", headerName: "FG Part", width: 150 },
        { field: "desc", headerName: "Description", flex: 1 },
        { field: "mat_type", headerName: "Mat Type", width: 100 },
        {
            field: "box_qty", headerName: "Per Qty", width: 100, align: "center",
            headerAlign: "center"
        },
        {
    ...
    useEffect(() => {
        const fetchData = async () => {
            const response = await GetPackingBomApi({ type: CCTypeEnum.TC })
...
export default CC_StoresAndSparesScreen;