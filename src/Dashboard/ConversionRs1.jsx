 ...
 const handleUploadData = async () => {
    if (!uploadedFile) {
      ...
      try {
        ...
        const response = await MovementConversion(formData)
...
const styleValidationColumns = (ws, headers, rowCount) => {
  ...
  const handleDownloadReportExcel = async () => {
    ...
    try {
      ...
      const fileName = "TrnConversionRs1 Movement List";
              ...
              {[
                ...
                .map((displayRole, idx) => {
                  ...
                  const roleMap = {
                    ...
                    'Level 2 - Plant Head': 'Plant Head',
                    'Level 3 - Corp Finance Head': 'Corp Finance Head',
                    'Level 4 - Business Head': 'Business Head',
