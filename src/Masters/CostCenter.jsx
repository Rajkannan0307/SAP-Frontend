...
import { getdetails,getAdd,getUpdates,getPlants } from "../controller/CostCenterapiservices";
...
const CostCenter = () => {
 ...
 const columns = [
     ...
     { field: "CostCenter_Name", headerName: "CostCenter Name", flex: 1 },
    ...
    >
      ...
      >
        <DataGrid
          ...
          getRowId={(row) => row.CostCenter_ID} // Specify a custom id field
      ...
      <TextField
                            label="CostCenter Code"
                            name="CostCenter Code"
                            value={CostCenterCode} // Use the current value of PlantCode
                            fullWidth
                            InputProps={{
                              readOnly: true, // Make it read-only
                            }}
